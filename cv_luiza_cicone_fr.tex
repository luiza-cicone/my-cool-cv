...
{Conception et implémentation d'une solution de gestion de questionnaires :}
...
\cvline{Programmation}{Java, C, Objective-C,  JavaScript}
\cvline{Frameworks}{Angular.js, D3.js, Express}
\cvline{Base de données}{MySQL, Oracle, SQLite, MongoDB}
\cvline {Outils}{git, subversion, LaTeX}
...
\cvlanguage{Français}{Courant, pratique quotidienne}{}
...
\cvlistitem{\small 1er prix du Festival International Francophone d'Improvisation Théâtrale Universitaire de Timisoara (FIFITUT) 2010}

\vspace{-.3cm}
\section{Loisirs}
\cvline{Sport}{\small basket-ball, ski, running trail, vélo }
\cvline{Musique}{\small piano et chant}
